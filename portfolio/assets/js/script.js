...
// Add click event listeners to each enlarge icon
enlargeIcons.forEach(icon => {
  icon.addEventListener('click', event => {
    event.preventDefault();
    const listItem = icon.closest('.project-item');
    const imageSrc = listItem.querySelector('img').getAttribute('src');
    enlargedImage.setAttribute('src', imageSrc);
    enlargedImageContainer.classList.remove('hidden');
  });
});

// Add click event listener to close button
closeButton.addEventListener('click', () => {
  enlargedImageContainer.classList.add('hidden');
});
